...
# NOT ci_data DOESN't EXIST
#ggplot(ci_data) + geom_line(aes(x_rct, y_control, color=0)) + geom_line(aes(x_rct, y_interv, color=1))
...
# TODO: interpred difference between graph with counterfactuals and without, does it match expectations given how their package works?
